...
title = "X-Y-Z Scan - All values in mm and seconds V03-R001"
...
class MyFrame(wx.Frame):
    ...
    def updateStat(mf,msg,f):
        ...
        mf.statusbar.SetStatusText(msg, f)
        if f != 0:
            mf.statusbar.SetStatusText("V3.1", 0)
...
class showImage(wx.Frame):
    def __init__(self, title = "BP_IMG"):
        wx.Frame.__init__(self, None , -1, title, size=(225,245))

        sm0 = "Scan # " + str(bp.sn)
        sm1 = "Z = " + str(bp.travelZ)
...
class DisplayResults(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, title="X0&FW4S_Z=" + str(bp.travelZ))


        smr0 = "Scan # " + str(bp.sn)
        smr1 = "Z = " + str(bp.travelZ)
